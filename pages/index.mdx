...
You can use any language that compiles to wasm, so if you like something we are missing, considder making an iddiomatic header/demo-project for your favorite language, and sending us a [PR](https://github.com/notnullgames/null0/pulls).
